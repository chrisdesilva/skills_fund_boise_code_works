...
const FAQ = () => {
     ...
     return (
          ...
          {faq.loanRange.length > 1 && <p>The maximum amount you can borrow will depend on your program.{faq.costOfLiving && <span> You can finance your tuition and cost of living expenses.</span>}</p>}
