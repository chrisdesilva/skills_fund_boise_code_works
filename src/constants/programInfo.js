...
export const leadContent = {
	...
	paragraph: `${schoolName} offers its Immersive Full Stack course to provide students a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
...
export const programLoanInfo = [
	// update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
	{
		...
		url: 'https://my.skills.fund/application?lenderCode=SFBOII17',
		loanInfo: {
...
export const programMaxText =
	'Choose the loan amount that works best for you. Borrow up to $7,800 for tuition and up to $3,000 for cost of living.';
