import logo from "../images/logo_boise.png" // add school logo to images folder and import here
...
export const schoolInfo = { // term details section
    ...
    interestOnly: [
        { // for multiple examples of interest only, add items to interestOnly array
            programName: '',
            APR36: '11.16%',
            financeCharge36: '$1,789.04',
            IOPayment36: '$60.77',
            FullMonthlyPayment36: '$257.92',
            APR60: '12.51%',
            financeCharge60: '$3,151.51',
            IOPayment60: '$74.29',
...
export const faq = { // faq section
    ...
    loanRange: [
        {
            programName: "the Immersive Full Stack program",
            maxAmount: "$7,800",
            col: true,
            colAmount: "$3,000"
        }
...
export const schoolName = "Boise CodeWorks"

export const schoolURL = 'https://boisecodeworks.com/' // update with url of school's website

export const skfURL = 'https://boisecodeworks.skills.fund' // update with Skills Fund url

export const headline = "Learn to Code at Boise CodeWorks" // update headline as appropriate

export const leadContent = {
    header: "Your last step on the path toward changing your career",
    paragraph: `${schoolName} offers its Immersive Full Stack course to provide students a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "Boise CodeWorks focuses exclusively on its Immersive Full Stack program."
    },
    step3: `You'll be on your way to an exciting career in tech as part of ${schoolName}'s powerful network.`
}

export const netlifyFormName = 'boisecodeworks_contact'

export const GATracking = 'UA-68312423-1'

export const hubspotFormId = "d12f4fa2-70b0-4018-8b8f-587bd7dc06b9" // create Hubspot form, get form id after publishing
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        name: "Immersive Full Stack",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SFBOII17",
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $7,800 for tuition and up to $3,000 for cost of living."
